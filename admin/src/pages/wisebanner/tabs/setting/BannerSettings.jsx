...
const BannerSettings = () => {
  ...
  return (
   <div className="relative block rounded-lg p-4 shadow-sm bg-slate-100 shadow-indigo-300 w-fit group">
      ...
      <div className="grid grid-cols-1 gap-4"> 
        ...
        />
        <SettingElementLayout title="Banner Type" element={<BannerType value={settingState.bannerType} handleChange={handleChange} />} />
        <SettingElementLayout
          title="Button Action"
          element={<BannerAction value={settingState.buttonAction} handleChange={handleChange}/>}
        />
        <div className="text-left text-blue-600 text-lg ml-2">
          Display Rules
        </div>
        <SettingElementLayout
